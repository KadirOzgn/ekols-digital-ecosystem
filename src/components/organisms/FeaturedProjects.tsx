...
const products = [
  { id: 1, src: '/products/product-1.jpg', category: 'Seri 01 / Ahşap', title: 'GEOMETRİK AHŞAP TABURE', accentColor: 'rgba(242, 202, 80, 0.4)' }, // Brand Primary Gold
  ...
  { id: 5, src: '/products/product-5.jpg', category: 'Seri 04 / Lake', title: 'MAVİ İKONİK TABURE', accentColor: 'rgba(212, 138, 85, 0.4)' }, // Vibrant Copper
...
export const FeaturedProjects = ({ dict, currentLang }: { dict?: any, currentLang?: string }) => {
  ...
  return (
    <section className="pl-margin py-xl bg-[#0d0e0f] overflow-hidden" id="products">
        <div className="flex justify-between items-end mb-16 pr-margin">
            <div>
        ...
        <div 
            ...
            className="flex overflow-x-auto gap-8 pb-12 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden pr-margin"
...
const ProductCard = ({ product, t }: { product: any, t: any }) => {
    ...
    return (
        <div 
            className="min-w-[75vw] md:min-w-[280px] lg:min-w-[320px] aspect-[3/4] flex-shrink-0 snap-center relative group cursor-pointer overflow-hidden border border-[#333535]/50 rounded-sm bg-[#0a0b0c]"
        >
